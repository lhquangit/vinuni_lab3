...
You can also run a lightweight Streamlit interface for the ReAct agent:
...
The UI shows:
- the prompt input
- live tool timeline with `running / success / fail`
- a short reason for why each tool is being called
- the final answer
- saved artifact paths for the run log, final answer txt, and final answer json
